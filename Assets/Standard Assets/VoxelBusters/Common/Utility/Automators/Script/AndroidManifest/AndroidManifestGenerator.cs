...
namespace VoxelBusters.Utility
{
    public partial class AndroidManifestGenerator
    {
        ...
        protected void WriteActivity(XmlWriter _xmlWriter, string _name, string _theme = null, string _orientation = null, string _configChanges = null, string _exported = null, string _comment = null, bool _usesHardwareAcceleration = false)
        {
            if (_comment != null)
            ...
            _xmlWriter.WriteStartElement("activity");
            {
                ...
                if (_usesHardwareAcceleration)
                {
                    WriteAttributeString(_xmlWriter, "android", "hardwareAccelerated", null, _usesHardwareAcceleration ? "true" : "false");
                }
        ...
        protected void WriteUsesPermission(XmlWriter _xmlWriter, string _name, string _toolsRemoveOption = null, Feature[] _features = null, string _comment = null)
        {
            if (_comment != null)
                _xmlWriter.WriteComment(_comment);
            ...
            {
                WriteAttributeString(_xmlWriter, "android", "name", null, _name);
                if(_toolsRemoveOption != null)
                {
                    WriteAttributeString(_xmlWriter, "tools", "remove", null, _toolsRemoveOption);
                }
            }
            _xmlWriter.WriteEndElement();
