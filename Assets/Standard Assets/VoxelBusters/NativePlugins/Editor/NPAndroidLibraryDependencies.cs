...
namespace VoxelBusters.NativePlugins
{
	...
	public class NPAndroidLibraryDependencies
	{
        ...
        private static readonly string PlayServicesVersionString	=	"17.0+";
        private static readonly string SupportLibsVersionString		=	"1.0.0+";
		private static readonly string ExifInterfaceVersionString	=	"1.1.0+";
        private static readonly string FCMVersionString             =   "20.0+";
				...
				_xmlWriter.WriteStartDocument();
				{
					...
					_xmlWriter.WriteStartElement("dependencies");
					{
						_xmlWriter.WriteStartElement ("androidPackages");
						{
							...
							{
								_xmlWriter.WriteComment("Dependency added for using Remote Notifications");
							...
							AndroidDependency _supportLibraryV4Dependency	= new AndroidDependency("androidx.legacy", "legacy-support-v4", SupportLibsVersionString);
							WritePackageDependency(_xmlWriter, _supportLibraryV4Dependency);

							AndroidDependency _supportLibraryExifDependency	= new AndroidDependency("androidx.exifinterface", "exifinterface", ExifInterfaceVersionString);
