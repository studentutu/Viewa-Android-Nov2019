...
namespace VoxelBusters.NativePlugins
{
	...
	public sealed partial class GameServicesIOS : GameServices 
	{
		...
		private 	const		string		kExternalAuthCredentials	= "external-authentication-credentials";
		...
		{
			IDictionary		_credentials				= _dataDict.GetIfAvailable<IDictionary>(kExternalAuthCredentials);
			string 			_error						= _dataDict.GetIfAvailable<string>(GameServicesIOS.kNativeMessageErrorKey);

			Debug.Log("External Auth Credentials : " + _credentials.ToJSON());
